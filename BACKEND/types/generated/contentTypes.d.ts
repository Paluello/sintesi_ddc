...
export interface ApiPostitPostit extends Struct.CollectionTypeSchema {
  collectionName: 'postits';
  info: {
    displayName: 'POSTIT';
    pluralName: 'postits';
    singularName: 'postit';
  ...
  attributes: {
    COMMENTI: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    STILE: Schema.Attribute.Enumeration<['a', 'b', 'c', 'd']>;
...
export interface ApiSettoreSettore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    postits: Schema.Attribute.Relation<'oneToMany', 'api::postit.postit'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
